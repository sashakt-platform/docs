...
- 📝 **Configure multiple question formats** — single-choice, multi-choice, subjective, numerical, and matrix — with images, audio, and video.
...
- 🏆 **Issue personalized certificates** automatically from a Google Slides template you design.
- 🌐 **Deliver tests in the language you choose** — set English or Hindi at the test level so candidates see the test in the right language from the start.
- 🔐 **Control access by region** with fine-grained roles for State, District, and Organization admins.
- 📊 **Collect and analyze data** with BigQuery sync to generate actionable insights.
